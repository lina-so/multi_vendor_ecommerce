    ...
    <tbody>
     ...
     @forelse ($products as $product )
        <tr>
            ...
            <td><img src="{{ asset('storage/' . $product->getFirstMedia('images')->id . '/' . $product->getFirstMedia('images')->file_name) }}" width="50" height="50"></td>
           @else
     ...
     @empty
     <tr>
        <td colspan="8" style="background-color:#007bff; color:white" class="text-center">No products Difined</td>
     </tr>
     @endforelse
    </tbody>
</table>
